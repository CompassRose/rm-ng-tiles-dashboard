import { CompactType, GridsterConfig, DisplayGrid, GridType } from 'angular-gridster2';

export const myGridOptions = {
  // itemChangeCallback:null,
  // itemResizeCallback: null,
  // itemResizeCallback: GridComponent.itemResize,
  compactType: CompactType.CompactUpAndLeft,
  margin: 15,  // margin between grid items
  outerMargin: true,  // if margins will apply to the sides of the container
  // outerMargin: null,
  outerMarginTop: 50,
  outerMarginRight: 120,
  ...
  // maxItemCols: 28,
  maxItemRows: 4,
  // maxItemArea: 1180, // Limits cells occupied -- 
  disableScrollHorizontal: true,
  disableScrollVertical: false,
  //keepFixedHeightInMobile: true, // keep the height from fixed gridType in mobile layout
  //keepFixedWidthInMobile: true, // keep the width from fixed gridType in mobile layout
  //minItemArea: 1,
  ...
  //ignoreContentClass: 'transparent-top',
  ignoreContent: true,
  ...
  draggable: {
    ...
    //   //console.log('*** Start -item ', event, ' $element ', $element, ' event ', event, '\n\n');
    // }.bind(this)
  },
  resizable: {
    enabled: false,
    // stop: (item, $element, event) => {
    //   console.log('*** Stop -item ', item, ' $element ', $element, ' event ', event, '\n\n');
    // },
    // start: (item, $element, event) => {
    //   console.log('*** Start -item ', item, ' $element ', $element, ' event ', event, '\n\n');
    // }
  },
  swap: true,
  pushItems: false,
...
//  maxItemAreea: 2500, // max item area: cols * rows
